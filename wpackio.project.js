...
module.exports = {
  // Project Identity
  appName: 'wenpriseAssets', // Unique name of your project
  type   : 'plugin', // Plugin or theme
  slug   : 'wenprise-assets', // Plugin or Theme slug, basically the directory name under `wp-content/<themes|plugins>`
